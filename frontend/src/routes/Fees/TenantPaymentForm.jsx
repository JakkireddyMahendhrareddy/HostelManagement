...
const TenantPaymentForm = ({ setShowDetailsModal }) => {
  ...
  const dueAmount = rent && payingAmount ? rent - payingAmount : "";
  ...
  return (
    <div className="fixed inset-0 z-10 overflow-y-auto">
      <div className="flex items-end justify-end min-h-screen pt-4 ml-20 px-2 pb-20 text-center sm:block sm:p-0">
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <div className="px-4 py-3 mt-4 sm:px-6 flex justify-end items-center gap-4">
              ...
              <button
                ...
                className="w-full sm:w-auto rounded-lg px-4 py-2 bg-blue-500 text-white hover:bg-blue-700"
              >
                Save
              </button>
            </div>
