...
//   // Local state to track tenant payment status
//   const [localTenantData, setLocalTenantData] = useState({});
//   const [updatedTenants, setUpdatedTenants] = useState([]);

//   // Process transactions and update local state
//   useEffect(() => {
//     if (!tenants || !transactions) return;

//     // Create a copy of tenants with additional payment info
//     const processedTenants = tenants.map((tenant) => {
//       // Find all transactions for this tenant
...
//       // Build processed tenant object with transaction data
//       return {
//         ...tenant,
//         processedDueDate: latestTransaction?.dueDate || null,
//         processedRentStatus:
//           latestTransaction?.rentStatus || tenant.status || "Due",
//       };
//     });

//     setUpdatedTenants(processedTenants);
