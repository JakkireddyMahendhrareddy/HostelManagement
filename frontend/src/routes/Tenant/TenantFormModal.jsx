...
const TenantFormModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-gray-300 transition-opacity  absolute  bg-opacity-75 flex justify-center items-center z-50 overflow-y-auto">
        ...
        >
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div
                className={formErrors.agreementStartDate ? "error-field" : ""}
              >
                <label
              ...
              <div className={formErrors.rentAmount ? "error-field" : ""}>
                ...
                <input
                  ...
                  onChange={handleTenantChange}
                  className={`w-full p-2 border rounded-md ${
                    formErrors.rentAmount ? "border-red-500" : "border-gray-300"
                  }`}
                />
