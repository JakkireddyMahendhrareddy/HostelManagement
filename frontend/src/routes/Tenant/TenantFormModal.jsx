  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        {/* Modal container */}
        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all w-full max-w-[95%] sm:my-8 sm:align-middle sm:max-w-4xl">
          <div className="bg-white px-4 py-5 sm:px-6 sm:py-6 relative">
            <div className="flex justify-between items-center border-b pb-3 mb-5">
              <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 text-center w-full">
                {isEditing ? "Edit Tenant Information" : "Add New Tenant"}
              </h2>
              <button
                onClick={() => {
                  resetForm();
                ...
                title="Close"
              >
                <FaTimes className="text-2xl text-red-600 hover:text-red-800 cursor-pointer" />
              </button>
            </div>
            ...
            >
              ...
              <div className="bg-purple-50 p-4 rounded-lg border border-purple-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  ...
                  <div
                    className={formErrors.emergencyMobile ? "error-field" : ""}
                  >
                    <label
