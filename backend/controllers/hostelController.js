...
export const addHostelInfo = async (req, res) => {
  ...
  try {
    ...
    res
      .status(201)
      .json({ success: true, message: "Hostel info added successfully." });
  } catch (err) {
...
export const getHostelInfo = async (req, res) => {
  ...
  try {
    ...
    if (!hostel) {
      return res
        .status(404)
        .json({ success: false, message: "No hostel found." });
    }
...
export const updateHostelSpecificInfo = async (req, res) => {
  ...
  try {
    ...
    if (!updatedHostel) {
      return res
        .status(404)
        .json({ success: false, message: "No hostel found to update." });
    }
...
export const deleteHostelInfo = async (req, res) => {
  ...
  try {
    ...
    if (!deletedHostel) {
      return res
        .status(404)
        .json({ success: false, message: "No hostel found to delete." });
    }
